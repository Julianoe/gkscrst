...
'/wordpress/?cat=6',
'/wordpress/?cat=23');*/
	/*ici l'url doit �tre le chemin complet sur l'h�bergeur.*/
	/*Si possible faire en sorte que l'url soit r�cup�r�e et ajout�e seulement � la partie '?cat= x' pour plus de simplicit� en cas de changement de nom, etc*/
